...
const Thanks = () => {
  return (
    <div className="pt-10 pb-10 bg-slate-950 shadow ">
      <section className="max-w-xl mx-auto">
        <h2 className="text-center text-xl font-semibold text-rose-400 p-5">
          Swetha Ramesh
        </h2>
        <p className="text-center text-gray-400 p-4">
          Thank you for taking your time and reading my site, If you have any
          suggestions or if you want to contact me for any reason.
        </p>
        <p className="text-center text-gray-400 p-4">
